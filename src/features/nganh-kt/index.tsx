  ...
  return (
    <LayoutNganh title="Ngành kế toán" image="/kt-a.png">
      <Branch 
        ...
        work={["Sinh viên tốt nghiệp chuyên ngành Kế toán doanh nghiệp có đủ năng lực đảm nhận các công việc về Kế toán doanh nghiệp và các lĩnh vực khác thuộc ngành Kế toán trong các công ty, tổ chức, tập đoàn trong và ngoài nước, các cơ quan Nhà nước; cụ thể: "]}
        workjobs={["Đảm nhận ngay công việc chuyên môn như: kế toán viên, nhân viên tài chính, kiểm soát viên tại các doanh nghiệp, các tập đoàn, tổng công ty thuộc mọi lĩnh vực, mọi thành phần kinh tế  ", "Làm việc chuyên môn tại Kiểm toán nhà nước; các công ty kiểm toán độc lập; các tổ chức tài chính - tín dụng; các cơ quan quản lý nhà nước","Làm việc tại các công ty thiết kế phần mềm về kế toán, quản trị doanh nghiệp", "Đủ khả năng khởi nghiệp cung cấp dịch vụ kế toán, tư vấn kế toán, tài chính, thuế cho các doanh nghiệp","Trở thành giảng viên, trợ giảng, chuyên gia tư vấn, nghiên cứu viên chuyên môn về lĩnh vực Kế toán nói chung và lĩnh vực Kế toán doanh nghiệp nói riêng  "]}
        person={[
